...
function classify(r) {
  ...
  else if (topicList.includes("booking") || slug.includes("reservation") || slug.includes("lounge"))
    aff = "普通";
...
lines.push(
  "> 対象: posts/ 配下の全Markdownファイル (" + results.filter((r) => !r.error).length + "件)",
);
lines.push("");
lines.push("## サマリー");
lines.push("");
