...
excerpt: パリのメトロ・RER・バスの違いと、旅行者がどのチケットを持つべきかを整理しました。短期滞在向けの単発券やNavigo Easy、よく乗るならNavigo Découverteの週券まで、迷いやすい論点に絞ってまとめています。
...
結論から言うと、短期滞在なら `Navigo Easy` か単発券、1週間でかなり乗るなら `Navigo Découverte` の週券が軸になります。ここではその判断だけに絞って整理します。

このページの料金は、著者が現地で使った判断材料に加えて、変動しやすい部分は Île-de-France Mobilités の公式案内を補足として参照しています。料金改定が入ることがあるので、購入前は公式料金表も確認してください。
