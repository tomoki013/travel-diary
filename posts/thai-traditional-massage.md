...
excerpt: タイ古式マッサージの総本山ワット・ポーでマッサージを受けるときの、料金・営業時間・混雑しやすい時間帯と待ち時間の目安を体験ベースでまとめました。寺院観光と一緒に組み込むときの注意点も整理しています。
description: ワットポーのタイ古式マッサージは60分480THB〜。料金表・営業時間・混雑しやすい時間帯と待ち時間の目安を体験ベースで解説します。
...
ワット・ポーは寺院だけでなく、タイ古式マッサージの総本山としても有名です。寺院観光と一緒に組み込みやすい一方で、混む時間帯に当たるとかなり待つので、そこだけ先に把握しておくと楽です。
