...
excerpt: パリを数日だけ動く短期滞在の旅行者向けに、交通系ICカード「Navigo Easy」の購入・チャージ方法と、向いているケースを整理しました。証明写真が要らず券売機ですぐ買える手軽さを中心にまとめています。
...
パリで数日だけ動くなら、交通はまず `Navigo Easy` を基準に考えると分かりやすいです。証明写真が要らず、券売機か窓口で買ってすぐ使えます。

週券まで必要ない短期滞在の旅行者にはかなり扱いやすいので、ここでは購入方法と向いているケースだけに絞って整理します。
