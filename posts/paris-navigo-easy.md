---
title: パリの電車・メトロの乗り方｜チケットの選び方とNavigo Easyの使い方
excerpt: パリの電車（メトロ・RER）・バスの乗り方と、チケットの違い、旅行者がどれを選ぶべきかを整理しました。短期滞在の軸になる交通系ICカード「Navigo Easy」の購入・チャージ・改札での使い方を中心に、実際に使った経験からまとめています。
description: パリの電車・メトロの乗り方を整理。メトロ・RER・バスの違い、1回券や週券などチケットの選び方、短期滞在向けNavigo Easyの購入・チャージ・改札での使い方を実体験ベースで解説します。
...
パリの電車・メトロは、使い始めるまで少し分かりにくいですが、旅行者が迷う論点はそこまで多くありません。メトロ・RER・バスの違いと、どのチケットを持つべきかを先に掴めば十分回れます。

乗り方自体はシンプルで、**チケットをカードに入れて、改札の読み取り部分にタッチするだけ**です。結論から言うと、数日だけ動く短期滞在なら交通系ICカード `Navigo Easy` を基準に考えるのが分かりやすいです。証明写真が要らず、券売機か窓口で買ってすぐ使えます。1週間でかなり乗るなら `Navigo Découverte` の週券が候補に入ります。
...
## パリの電車・メトロの乗り方｜メトロ・RER・バスの違い

パリの公共交通機関は、メトロ（地下鉄）、RER（高速郊外鉄道）、バス、トラム、モンマルトルのケーブルカーなど複数ありますが、すべて共通のチケット体系で利用できます。

- **メトロ**: 市内の移動の基本。駅間が短く、観光地のほとんどはメトロで着きます。
- **RER**: 郊外まで伸びる高速鉄道。ヴェルサイユ宮殿や空港への移動で使います。
- **バス・トラム**: メトロと同じカードで乗れますが、1回券の種類が別になります（後述）。

乗るときの流れは、チケット（または Navigo Easy）を用意して改札の読み取り部分にタッチし、ホームへ降りるだけです。改札の通り方は後半の「Navigo Easyの使い方」で書いています。
...
## Navigo Easyの使い方｜購入・チャージ・改札の通り方
...
実際にパリで使った実感として、Navigo Easyがあると「切符を買う」という小さなストレスが旅から消えます。メトロで移動するたびに券売機に並ぶ必要がなくなるので、その分一つでも多くの美術館を訪れたり、カフェで時間を過ごしたりできます。

一方で引っかかりやすいのは、1回券がメトロ・RER用とバス・トラム用で別になっている点です。メトロ用だけチャージしてバスに乗ろうとすると使えないので、バスも使う予定ならバス用も入れておく方が安心です。

パリで歩き回った日の記録や、行ってよかったお店は、こちらにまとめています。
...
パリからスペインへ抜けた旅程全体と費用は、ヨーロッパ周遊のまとめに書いています。
