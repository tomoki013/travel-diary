...
excerpt: インドのe-VISA申請手順と必要書類を、申請時に詰まりやすい点を中心に整理しました。利用可能な空港・港の情報も含め、実体験ベースでまとめています。
...
- インド観光にはオンラインで申請できる**e-TOURIST-VISA**が最もおすすめです。
- 申請にはパスポート（PDF）と顔写真（JPEG）が必要。入力項目が多く、完了まで1〜2時間かかります。
- **出発の2週間前**までには申請を完了させておくのが安心です。
- 支払いはクレジットカードまたはPayPal。承認されるとメールで届くので印刷して持参しましょう。

## 基本情報

| 項目       | 内容                                                                              |
| ---------- | --------------------------------------------------------------------------------- |
| ビザの種類 | e-TOURIST-VISA (30日 / 1年 / 5年)                                                 |
| 申請方法   | [公式サイト](https://indianvisaonline.gov.in/evisa/tvoa.html)からのオンライン申請 |
| 必要なもの | パスポート、顔写真データ、クレジットカード/PayPal                                 |
| 料金       | 約26ドル（手数料込み）                                                            |
| 所要日数   | 通常72時間以内（24時間で届くことも多い）                                          |
