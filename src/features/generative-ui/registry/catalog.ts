...
export interface ComponentDefinition {
  ...
  category: "Layout" | "Typography" | "DataDisplay" | "Feedback" | "Navigation" | "Media" | "Special";
}
...
export const COMPONENT_CATALOG: ComponentDefinition[] = [
  // Layout
  {
    type: "section",
    category: "Layout",
    description: "白背景・境界線・余白を持つ情報の大きなまとまり。原則として全てのトップレベルコンテンツはこれに含める。",
  ...
  },
  {
    type: "flex_row",
    category: "Layout",
    description: "子要素を水平方向（横）に並べる。デスクトップでは横並び、モバイルでは自動的に縦に折り返すレスポンシブ仕様。",
  ...
  },
  {
    type: "grid",
    category: "Layout",
    description: "要素を格子状に並べる。PC/タブレットでは指定した列数、モバイルでは自動的に1列になる。PCでの2カラム・3カラム構成に必須。",
  ...
  // Typography
  {
    type: "heading_h1",
    category: "Typography",
    description: "ページ最上部の特大見出し。必ず「text」プロパティに目を引くメインタイトルを設定すること。",
    bestUsedFor: "メインタイトル",
  ...
  },
  {
    type: "body_text",
    category: "Typography",
    description: "標準的な本文テキスト。「text」プロパティにユーザーの課題を解決する説明を詳しく書くこと。",
  ...
  },
  {
    type: "caption_text",
    category: "Typography",
    description: "補足情報や注釈用の小さなテキスト。「text」プロパティに具体的な補足説明を書くこと。",
  ...
  },
  {
    type: "quote_block",
    category: "Typography",
    description: "引用形式のテキストブロック。「text」プロパティに印象的なメッセージやレビューを書くこと。",
  ...
  // Data Display
  {
    ...
    propsExample: { columns: ["項目", "価格"], rows: [["ホテル", "¥5,000"], ["食事", "¥2,000"]] }
  },
  {
    type: "key_value_list",
    category: "DataDisplay",
    ...
    propsExample: { items: [{ label: "所要時間", value: "約30分" }, { label: "難易度", value: "初級" }] }
  },
  {
    type: "progress_bar",
    category: "DataDisplay",
  ...
  },
  {
    ...
    propsExample: { items: [{ title: "成田出発", time: "10:00" }, { title: "バンコク到着", time: "16:00" }] }
  },
  {
    ...
    propsExample: { left: { title: "電車", items: ["安い", "正確"] }, right: { title: "タクシー", items: ["速い", "楽"] } }
  },
  ...
  // Feedback & Callout
  {
    type: "alert_box",
    category: "Feedback",
    description: "重要度に応じた通知ボックス。「title」と「text」プロパティに具体的な案内を書き、空にしないこと。",
    bestUsedFor: "警告、成功通知、重要な案内",
    propsExample: { variant: "warning", title: "注意", text: "パスポート前期限を確認してください。" }
  },
  {
    type: "tip_callout",
    category: "Feedback",
    description: "豆知識やヒントを示す電球マーク付きのボックス。「text」プロパティに具体的なアドバイスを書くこと。",
  ...
  },
  {
    type: "did_you_know",
    category: "Feedback",
    description: "「ご存知ですか？」形式の雑学パネル。「title」と「text」プロパティを必ず埋めること。",
  ...
  },
  {
    ...
    propsExample: { title: "準備リストを確認する", description: "忘れ物がないかチェックしましょう", articleId: "id" }
  },
  {
  ...
  // Special High-Impact Components
  {
    type: "hero_section",
    category: "Special",
    description: "画面全体または大部分を占める、画像背景と大きなタイトルを持つドラマチックなセクション。ユーザーを一瞬で引き込む。",
    bestUsedFor: "ページの最上部、最も重要なテーマの提示",
    propsExample: { title: "タイの絶景を巡る旅", subtitle: "心揺さぶる体験がここに", articleId: "id", height: "full" }
  },
  {
    type: "featured_card",
    category: "Layout",
    description: "画像とテキストが洗練されたバランスで配置された、特別感のあるカード。背景のグラデーションやアニメーションが特徴。",
    bestUsedFor: "最優先で読ませたい記事やおすすめスポット",
    propsExample: { title: "必見！スワンナプーム活用術", description: "これさえ読めば不安ゼロ", articleId: "id", badge: "人気No.1" }
  }
];
