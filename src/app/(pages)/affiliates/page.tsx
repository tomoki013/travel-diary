...
const Affiliates = () => {
  ...
  return (
    <LegalPageLayout
      title="アフィリエイトポリシー"
      description="当サイトでは、商品やサービスを紹介する際にアフィリエイトプログラムを利用しています。読者の皆様に誠実な情報を提供するため、以下の方針を遵守することをお約束します。"
      enactedDate="2025年9月3日"
    ...
    >
      ...
      <ul>
        {appsToShow.map((app) => (
          <li key={app.homeUrl}>
            <Link target="_blank" rel="noopener noreferrer" href={app.homeUrl}>
              {app.name}
            </Link>
          </li>
        ))}
