...
const CookiePolicyPage = () => {
  return (
    <LegalPageLayout
      title="クッキーポリシー"
      description="当サイト「ともきちの旅行日記」では、より良いサービスを提供し、快適にご利用いただくために Cookie（クッキー）を使用しています。本ポリシーでは、その定義・収集する情報・使用目的・管理方法を説明します。"
      enactedDate="2025年8月21日"
