...
const EditorialPolicyPage = () => {
  return (
    <LegalPageLayout
      title="執筆・編集ポリシー"
      description="当サイト「ともきちの旅行日記」では、旅の体験を伝える記事と、現地で役立つ実用記事を同じ書き方で扱わないようにしています。このページでは、記事をどのような考え方で書き、更新しているかを公開向けに整理しています。"
      enactedDate="2026年2月10日"
      updatedDate="2026年3月26日"
    >
      <h2>1. このページの目的</h2>
      <p>
      ...
      <h2>6. 広告・アフィリエイトとの関係</h2>
      <p>
        当サイトでは、アフィリエイトプログラムを利用する記事があります。ただし、紹介する商品やサービスは、運営者が実際に使ったもの、または明確な体験と判断材料を持って書けるものを優先しています。
      </p>
      <p>
        詳しい基準については<Link href="/affiliates">アフィリエイトポリシー</Link>をご確認ください。
      </p>

      <h2>7. 記事の修正・更新について</h2>
      <p>
      ...
      <ul className="list-disc pl-6">
        <li>
          個人情報や免責事項については<Link href="/privacy">プライバシーポリシー</Link>
          をご確認ください。
        </li>
        <li>
          サイト利用条件については<Link href="/terms">利用規約</Link>をご確認ください。
        </li>
        <li>
          Cookie の取り扱いについては<Link href="/cookie-policy">クッキーポリシー</Link>
          をご確認ください。
        </li>
      </ul>
