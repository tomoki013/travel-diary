...
export const metadata: Metadata = {
  ...
  // NOTE: サイトに実在する内容だけを書くこと。過去に、撤去済みの機能
  // (旅費計算・世界時計・ルーレット等)を列挙したまま放置され、検索結果と
  // 実際のサイト内容が食い違う状態になっていた。
  description:
    "ともきちの旅行日記は、実際に旅した体験をもとに、旅行記・観光や移動のガイド・写真ギャラリーをまとめた個人旅行ブログです。空港から市内へのアクセスや現地の交通、費用の記録など、旅の計画に役立つ一次情報を発信しています。",
  authors: [{ name: "ともきち" }],
  openGraph: {
