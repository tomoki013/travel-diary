...
export const affiliates: AffiliatesProps[] = [
  {
    ...
    type: "banner",
    icon: <BedDouble className="text-primary h-10 w-10" />,
    description:
  ...
  {
    name: "GetYourGuide",
    affiliateUrl: "https://www.getyourguide.com?partner_id=GTNOM0E&utm_medium=online_publisher",
  ...
  },
  {
    ...
    type: "card",
    icon: <Train className="text-primary h-10 w-10" />,
  ...
  },
  {
    ...
    homeUrl: "YOUR_AFFILIATE_LINK_HERE",
    type: "card",
    icon: <Plane className="text-primary h-10 w-10" />,
  ...
  },
  {
    ...
    homeUrl: "YOUR_AFFILIATE_LINK_HERE",
    type: "card",
    icon: <Wifi className="text-primary h-10 w-10" />,
  ...
  {
    name: "一休.com",
    affiliateUrl: "//ck.jp.ap.valuecommerce.com/servlet/referral?sid=3759091&pid=892355798",
    homeUrl: "https://www.ikyu.com/",
    type: "card",
    icon: <BedDouble className="text-primary h-10 w-10" />,
    description: "全国約7,000の厳選した高級ホテル・旅館、またワンランク上のビジネスホテルを",
    status: "ready",
