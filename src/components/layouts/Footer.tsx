  ...
  return (
    <footer className="relative border-t border-stone-200 bg-stone-50/50 text-stone-900 dark:border-stone-800 dark:bg-[#080808] dark:text-stone-100">
      <div className="container mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-8">
            <div className="space-y-6">
              <h3 className="text-sm font-bold tracking-widest text-amber-600 uppercase dark:text-amber-500">
                Explore
              </h3>
            ...
            <div className="col-span-2 space-y-6 sm:col-span-1">
              <h3 className="text-sm font-bold tracking-widest text-stone-400 uppercase">Legal</h3>
              <ul className="space-y-3">
        ...
        <div className="mt-16 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-stone-200 lg:p-8 dark:bg-stone-900/50 dark:ring-stone-800">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-stone-200 pt-8 sm:flex-row dark:border-stone-800">
          <p className="text-xs text-stone-500 dark:text-stone-400">
            &copy; 2024-{new Date().getFullYear()} ともきちの旅行日記. All rights reserved.
          </p>
