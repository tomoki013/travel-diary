...
const JourneyCard = ({ item, index }: { item: JourneyItem; index: number }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content Side */}
      <div className={cn("w-full md:w-1/2 pl-12 md:pl-0", isEven ? "md:pr-16" : "md:pl-16")}>
...
const JourneyTimeline = () => {
  ...
  return (
    <div ref={containerRef} className="relative py-20 px-4 md:px-8 overflow-hidden">
      {/* Central Line */}
      ...
      <div className="relative mt-20 text-center">
        <div className="inline-flex flex-col items-center gap-3">
            ...
            <p className="text-muted-foreground text-sm tracking-widest uppercase">To be continued...</p>
        </div>
      </div>
    </div>
  );
