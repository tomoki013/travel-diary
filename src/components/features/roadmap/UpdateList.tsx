...
const UPDATES: UpdateItem[] = [
  {
    ...
    content:
      "読み込み中のアニメーションを刷新しました。初回表示時は飛行機が航路を描き、サイト名がふわっと現れるオープニング、ページの切り替え時は飛行機の航路、世界地図や検索の待ち時間はやわらかい熱気球が浮かぶアニメーションになります。あわせて記事を探す画面のボタンの色や形を統一し、絞り込み中は背景がスクロールしないように修正。記事の共有は端末の共有メニューとリンクコピーに整理しました。",
    type: "patch",
  },
  {
    date: "2026.06.22",
