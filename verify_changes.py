...
def verify_changes(page):
    ...
    # We check if these links are present and visible near the heading.
    # Note: Structure might be simpler to just check existence on page in footer area.
    page.get_by_role("link", name="FAQ", exact=True).scroll_into_view_if_needed()
